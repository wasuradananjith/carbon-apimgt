...
public class ExportApiServiceImpl implements ExportApiService {
    ...
    public Response exportApplicationsGet(String appName, String appOwner, Boolean withKeys,
        ...
        try {
            ...
            } else if (!MultitenantUtils.getTenantDomain(applicationDetails.getSubscriber().getName()).equals(MultitenantUtils.getTenantDomain(username))) {  // normal non-migration flow
            ...
            RestApiUtil.handleInternalServerError("Error while exporting Application: " + appName, e, log);
        }
        Response.ResponseBuilder responseBuilder =
                Response.status(Response.Status.OK).entity(exportedApplicationArchiveFile).type(MediaType.APPLICATION_OCTET_STREAM);
