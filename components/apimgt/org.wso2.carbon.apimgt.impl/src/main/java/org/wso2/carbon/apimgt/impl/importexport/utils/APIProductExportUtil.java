...
public class APIProductExportUtil {
    ...
    public static void retrieveApiProductToExport(String archiveBasePath, APIProduct apiProductToReturn, APIProvider provider, String userName,
        ...
        try {
            ...
            String errorMessage = "Unable to retrieve Documentation for API Product: " + apiProductIdentifier.getName()
    ...
    private static void exportAPIProductMetaInformation(String archivePath, APIProduct apiProductToReturn, Registry registry,
        ...
        try {
            ...
            //apiProductToReturn.setUriTemplates(new LinkedHashSet<>());
     ...
     */
    private static void cleanApiProductDataToExport(APIProduct apiProduct) throws APIManagementException {
    ...
    /**
     * Exports an API Product from API Manager for a given API Product ID. Meta information, API icon, documentation
