...
public class APIProductImportUtil {
     ...
     * @param providerName              API Product provider  (Change based on the value of isDefaultProviderAllowed)
     */
    ...
    private static void checkAPIProductResourcesValid(String path, String currentUser, APIProvider apiProvider,
        ...
        // invalidProductResources != null means, at least one of the resources of the API Product does not have corresponding APIs
